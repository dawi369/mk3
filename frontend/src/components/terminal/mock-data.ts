    ...
    winners: [
      {
        ...
        change: 2.5,
        price: 77.1,
        stats: generateStats(77.1),
        sparklineData: generateSparklineData(77.1),
      },
      {
        ticker: "NGF6",
        change: 1.8,
        price: 2.95,
        stats: generateStats(2.95),
        sparklineData: generateSparklineData(2.95),
      },
      {
        ticker: "RBF6",
        change: 1.2,
        price: 2.2,
        stats: generateStats(2.2),
        sparklineData: generateSparklineData(2.2),
      },
    ],
    losers: [
      {
      ...
      },
      {
        ...
        change: -0.1,
        price: 76.5,
        stats: generateStats(76.5),
        sparklineData: generateSparklineData(76.5),
      },
      {
        ticker: "NGG6",
        change: -0.05,
        price: 3.05,
        stats: generateStats(3.05),
        sparklineData: generateSparklineData(3.05),
      },
    ],
  },
  {
