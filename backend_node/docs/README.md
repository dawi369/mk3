# MK3 Futures Dashboard - Backend

## Overview

This is the backend for the MK3 Futures Dashboard. It consists of:

1.  **Hub Server**: Ingests real-time data from Polygon.io, normalizes it, and writes to Redis Streams (`market_data`).
2.  **Redis**: Acts as the central event bus (Streams) and persistent storage.
3.  **Workers (Future)**: Consume data from Redis Streams for ML/Backtesting.

> **Note**: The "Edge Server" component is deprecated in favor of direct Redis Stream consumption. Phase 2 Complete ✅ | Edge Phase 3 In Progress 🔄
...
- [System Overview](./system-overview.md) - The big picture
- [Architecture Details](./architecture.md) - Technical deep dive

### Implementation Details

- [Futures Contract Management](./futures-contract-management.md)
- [Subscription Refresh Logic](./subscription-refresh-implementation.md)
- [Testing Subscription Refresh](./testing-subscription-refresh.md)
